...
class GRUCell2(GRUCell):
    ...
    def __init__(self,
        ...
        self.state_in = tf.compat.v1.placeholder(shape=[None, None, self._num_units], dtype=Const.FLOAT)
...
class TestGRUCell2(unittest.TestCase):
    ...
    def run_rnn_grucell2(self):
        ...
        data = tf.compat.v1.placeholder(Const.FLOAT, [None, 20, 3])  # Number of examples, number of input, dimension of each input
        target = tf.compat.v1.placeholder(Const.FLOAT, [None, 21])
        num_hidden = 24
        n_samples = 5
        ...
        W1, b1, W2, b2 = tf.compat.v1.get_variable(name='w1', shape=[n_samples, n_bacthes] + dW1, initializer=tf.compat.v1.constant_initializer(0.1),
                                         dtype=Const.FLOAT), \
                         tf.compat.v1.get_variable(name='b1', shape=[n_samples, n_bacthes] + db1, initializer=tf.compat.v1.constant_initializer(0.1),
                                         dtype=Const.FLOAT), \
                         tf.compat.v1.get_variable(name='w2', shape=[n_samples, n_bacthes] + dW2, initializer=tf.compat.v1.constant_initializer(0.1),
                                         dtype=Const.FLOAT), \
                         tf.compat.v1.get_variable(name='b2', shape=[n_samples, n_bacthes] + db2, initializer=tf.compat.v1.constant_initializer(0.1),
                                         dtype=Const.FLOAT)
        ...
        # Disable JIT compilation and XLA to prevent compilation errors
